...
class ChangeTransferView: UIView {
    ...
    lazy var Line1: UILabel = {
        let title = UILabel()
        title.frame = CGRect(x: 50, y: 45, width: UIScreen.main.bounds.size.width - 100, height: 2)
    ...
    lazy var Line2: UILabel = {
        let title = UILabel()
        title.frame = CGRect(x: 50, y: 92, width: UIScreen.main.bounds.size.width - 100, height: 2)
        title.backgroundColor = colorLine
        return title
    }()
    ...
    lazy var Line3: UILabel = {
        let title = UILabel()
        title.frame = CGRect(x: 50, y: 94, width: UIScreen.main.bounds.size.width - 100, height: 2)
        title.backgroundColor = colorLine
        return title
    }()
    ...
    lazy var Line4: UILabel = {
        let title = UILabel()
        title.frame = CGRect(x: 50, y: 141, width: UIScreen.main.bounds.size.width - 100, height: 2)
        title.backgroundColor = colorLine
        return title
    }()
