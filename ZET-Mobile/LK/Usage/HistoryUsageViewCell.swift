...
override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    titleThree.frame = CGRect(x: Int(UIScreen.main.bounds.size.width) - (titleThree.text!.count * 15) - 10, y: 10, width: (titleThree.text!.count * 15), height: 50)
    
    
    titleFour.text = "buinkn"
