...
class TabMobileCollectionViewCell: UICollectionViewCell {
    ...
    lazy var titleTwo: UILabel = {
        let title = UILabel()
        title.text = "Сумма перевода (сомони)"
        title.numberOfLines = 0
    ...
    lazy var title_commission: UILabel = {
        ...
        title.lineBreakMode = NSLineBreakMode.byWordWrapping
        title.textAlignment = .left
        title.frame = CGRect(x: 20, y: 310, width: 300, height: 20)
        title.autoresizesSubviews = true
        title.autoresizingMask = [.flexibleHeight, .flexibleWidth]
        return title
    }()
    ...
    lazy var title_info: UILabel = {
        let title = UILabel()
        title.text = "С помощью данной услуги, Вы можете со своего счёта пополнить счёт друзей, родных и близких!"
        title.numberOfLines = 3
        title.textColor = UIColor(red: 0.741, green: 0.741, blue: 0.741, alpha: 1)
        title.font = UIFont(name: "", size: 10)
        title.lineBreakMode = NSLineBreakMode.byWordWrapping
        title.textAlignment = .left
        title.frame = CGRect(x: 20, y: 350, width: UIScreen.main.bounds.size.width - 40, height: 70)
        title.autoresizesSubviews = true
        title.autoresizingMask = [.flexibleHeight, .flexibleWidth]
        return title
    }()
    ...
    lazy var icon_more: UIButton = {
        ...
        icon_more.frame = CGRect(x: 20, y: 430, width: 200, height: 20)
    ...
    override init(frame: CGRect) {
        ...
        slider.frame = CGRect(x: 20, y: 260, width: UIScreen.main.bounds.size.width - 40, height: 30)
